...
if 'Rank\r\n18/07/24' in rankings_df.columns:
    rankings_df['Rank'] = rankings_df['Rank\r\n18/07/24'].apply(
        lambda x: 100 if x == '>100' else int(x))  # Convert ranks to integers
    rankings_df.drop(columns=['Rank\r\n18/07/24'], inplace=True)
else:
    print("Column 'Rank\r\n18/07/24' not found in rankings_df")
